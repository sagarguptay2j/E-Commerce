...
$sql="select product.*,categories.categories from product,categories where product.categories_id=categories.id and product.sel_id=$sel_id order by product.id desc";
